...
export function FormError({id, error, additionnalClass}) {
    return (
        <div className={`form-error ${additionnalClass}`} id={id} role="alert" aria-live="assertive">
            <svg className="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 96 960 960" aria-hidden="true" focusable="false">
